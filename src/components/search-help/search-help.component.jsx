...
const SearchHelpComponent = ({ isOpen, toggleSearchInfo }) => {
          ...
          <ul>
            ...
            <li>
              <span>
                ...
                <br></br>
                Use <strong>p:</strong> followed by a number to search for nodes
                with a specific number of allocated points. Example: p:3
              </span>
            </li>
            <li>
              <span>
            ...
            <li>
              <span>
                ...
                <br></br>
                Use <strong>nt:</strong> followed by the node type to search for
                specific node types. Example: nt:activeSkill
              </span>
            </li>
            <li>
              <span>
